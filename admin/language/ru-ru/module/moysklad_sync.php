...
$_['help_incoming_quantity_mode'] = 'Legacy-настройка оставлена для обратной совместимости, но в активной логике 1.0.2 не используется. Количество на сайте управляется отдельной настройкой выше.';
...
$_['text_stage3_notice'] = 'Импорт создает категории, выгружает товары выбранного склада с остатком > 0, учитывает выбранные заказы поставщикам по ID номенклатуры МойСклад и отдельно загружает изображения маленькими пакетами.';
