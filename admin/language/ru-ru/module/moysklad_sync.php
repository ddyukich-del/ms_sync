...
$_['help_purchase_orders_enabled'] = 'Если включено, модуль дополнительно просматривает заказы поставщикам. Позиции заказа сопоставляются с номенклатурой строго по ID товара МойСклад из assortment.meta.href.';
...
$_['help_incoming_quantity_mode'] = 'Legacy-настройка оставлена для обратной совместимости, но в активной логике 1.1.0 не используется. Количество на сайте управляется отдельной настройкой выше.';
